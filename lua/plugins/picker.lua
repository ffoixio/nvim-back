...
local function pick(cmd, opts)
  ...
  local source = commands[cmd] or cmd
  return function()
      ...
      servers = {
        ["*"] = {
          ...
          keys = {
            ...
            { "<leader>ss", function() Snacks.picker.lsp_symbols({ filter = require("config.icons").kind_filter }) end, desc = "LSP Symbols", has = "documentSymbol" },
            { "<leader>sS", function() Snacks.picker.lsp_workspace_symbols({ filter = require("config.icons").kind_filter }) end, desc = "LSP Workspace Symbols", has = "workspace/symbols" },
